        ...
        if (temp === undefined) {
            ...
            if (this.currentState) {
                ...
                for (const [key, quality] of this.trackedQualities) {
                    ...
                    if (quality.targetValue) {
                        if (quality.targetValues) {
                            quality.targetValues.push(quality.targetValue);
                        } else {
                            quality.targetValues = [quality.targetValue];
                        }
                        quality.targetValue = undefined;
                        dirty = true;
                    }
                }
                if (dirty) {
